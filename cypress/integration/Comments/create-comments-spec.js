...
describe('Make new comments on request', () => {
  ...
  it('checks if new comments can be added to request owner section', () => {
    const {
      selectors,
      routes: { commentsRoute },
    } = comments;
  ...
  it('checks if new comments can be added to request business unit section', () => {
    const {
      selectors,
      routes: { commentsRoute },
    } = comments;
  ...
  it('checks if new comments can be added to request number section', () => {
    const {
      selectors,
      routes: { commentsRoute },
    } = comments;
